...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Virtual Memory Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.osate.aadl2.impl.VirtualMemoryTypeImpl#getOwnedFeatures <em>Owned Feature</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.VirtualMemoryTypeImpl#getOwnedDataPorts <em>Owned Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.VirtualMemoryTypeImpl#getOwnedEventDataPorts <em>Owned Event Data Port</em>}</li>
 *   <li>{@link org.osate.aadl2.impl.VirtualMemoryTypeImpl#getOwnedEventPorts <em>Owned Event Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualMemoryTypeImpl extends ComponentTypeImpl implements VirtualMemoryType {
	/**
	 ...
	 * @generated
	 */
	protected VirtualMemoryTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Aadl2Package.eINSTANCE.getVirtualMemoryType();
	}
			...
			if (ownedFeatures == null) {
				cache.put(eResource, this, Aadl2Package.eINSTANCE.getComponentType_OwnedFeature(),
						ownedFeatures = new DerivedUnionEObjectEList<Feature>(Feature.class, this,
								Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_FEATURE, OWNED_FEATURE_ESUBSETS));
			}
	...
	protected static final int[] OWNED_FEATURE_ESUBSETS = new int[] {
			Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_FEATURE_GROUP,
			Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_ABSTRACT_FEATURE, Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_DATA_PORT,
			Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_EVENT_DATA_PORT,
			Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_EVENT_PORT };
	...
	public EList<DataPort> getOwnedDataPorts() {
		if (ownedDataPorts == null) {
			ownedDataPorts = new EObjectContainmentEList<DataPort>(DataPort.class, this,
					Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_DATA_PORT);
		}
	...
	public boolean isSetOwnedFeatures() {
		return super.isSetOwnedFeatures() || eIsSet(Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_DATA_PORT)
				|| eIsSet(Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_EVENT_DATA_PORT)
				|| eIsSet(Aadl2Package.VIRTUAL_MEMORY_TYPE__OWNED_EVENT_PORT);
	}
