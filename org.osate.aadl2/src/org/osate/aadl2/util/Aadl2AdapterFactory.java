...
public class Aadl2AdapterFactory extends AdapterFactoryImpl {
	...
	protected Aadl2Switch<Adapter> modelSwitch = new Aadl2Switch<Adapter>() {
		...
		@Override
		public Adapter caseVirtualMemory(VirtualMemory object) {
			return createVirtualMemoryAdapter();
		}

		@Override
		public Adapter caseVirtualMemoryClassifier(VirtualMemoryClassifier object) {
			return createVirtualMemoryClassifierAdapter();
		}

		@Override
		public Adapter caseVirtualMemoryType(VirtualMemoryType object) {
			return createVirtualMemoryTypeAdapter();
		}

		@Override
		public Adapter caseVirtualMemoryImplementation(VirtualMemoryImplementation object) {
			return createVirtualMemoryImplementationAdapter();
		}

		@Override
		public Adapter caseVirtualMemoryPrototype(VirtualMemoryPrototype object) {
			return createVirtualMemoryPrototypeAdapter();
		}

		@Override
		public Adapter caseVirtualMemorySubcomponent(VirtualMemorySubcomponent object) {
			return createVirtualMemorySubcomponentAdapter();
		}

		@Override
		public Adapter caseVirtualMemorySubcomponentType(VirtualMemorySubcomponentType object) {
			return createVirtualMemorySubcomponentTypeAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemory <em>Virtual Memory</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemoryClassifier <em>Virtual Memory Classifier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVirtualMemoryClassifierAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemoryType <em>Virtual Memory Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemoryImplementation <em>Virtual Memory Implementation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemoryPrototype <em>Virtual Memory Prototype</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemorySubcomponent <em>Virtual Memory Subcomponent</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.osate.aadl2.VirtualMemorySubcomponentType <em>Virtual Memory Subcomponent Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVirtualMemorySubcomponentTypeAdapter() {
		return null;
	}
