...
public class Aadl2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Aadl2Package.VIRTUAL_MEMORY: {
			VirtualMemory virtualMemory = (VirtualMemory) theEObject;
			T result = caseVirtualMemory(virtualMemory);
			if (result == null)
				result = caseNamedElement(virtualMemory);
			if (result == null)
				result = caseElement(virtualMemory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_CLASSIFIER: {
			VirtualMemoryClassifier virtualMemoryClassifier = (VirtualMemoryClassifier) theEObject;
			T result = caseVirtualMemoryClassifier(virtualMemoryClassifier);
			if (result == null)
				result = caseComponentClassifier(virtualMemoryClassifier);
			if (result == null)
				result = caseVirtualMemory(virtualMemoryClassifier);
			if (result == null)
				result = caseVirtualMemorySubcomponentType(virtualMemoryClassifier);
			if (result == null)
				result = caseClassifier(virtualMemoryClassifier);
			if (result == null)
				result = caseSubcomponentType(virtualMemoryClassifier);
			if (result == null)
				result = caseFeatureClassifier(virtualMemoryClassifier);
			if (result == null)
				result = caseNamespace(virtualMemoryClassifier);
			if (result == null)
				result = caseType(virtualMemoryClassifier);
			if (result == null)
				result = caseNamedElement(virtualMemoryClassifier);
			if (result == null)
				result = caseElement(virtualMemoryClassifier);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_TYPE: {
			VirtualMemoryType virtualMemoryType = (VirtualMemoryType) theEObject;
			T result = caseVirtualMemoryType(virtualMemoryType);
			if (result == null)
				result = caseComponentType(virtualMemoryType);
			if (result == null)
				result = caseVirtualMemoryClassifier(virtualMemoryType);
			if (result == null)
				result = caseComponentClassifier(virtualMemoryType);
			if (result == null)
				result = caseVirtualMemory(virtualMemoryType);
			if (result == null)
				result = caseVirtualMemorySubcomponentType(virtualMemoryType);
			if (result == null)
				result = caseClassifier(virtualMemoryType);
			if (result == null)
				result = caseSubcomponentType(virtualMemoryType);
			if (result == null)
				result = caseFeatureClassifier(virtualMemoryType);
			if (result == null)
				result = caseNamespace(virtualMemoryType);
			if (result == null)
				result = caseType(virtualMemoryType);
			if (result == null)
				result = caseNamedElement(virtualMemoryType);
			if (result == null)
				result = caseElement(virtualMemoryType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_IMPLEMENTATION: {
			VirtualMemoryImplementation virtualMemoryImplementation = (VirtualMemoryImplementation) theEObject;
			T result = caseVirtualMemoryImplementation(virtualMemoryImplementation);
			if (result == null)
				result = caseComponentImplementation(virtualMemoryImplementation);
			if (result == null)
				result = caseVirtualMemoryClassifier(virtualMemoryImplementation);
			if (result == null)
				result = caseComponentClassifier(virtualMemoryImplementation);
			if (result == null)
				result = caseVirtualMemory(virtualMemoryImplementation);
			if (result == null)
				result = caseVirtualMemorySubcomponentType(virtualMemoryImplementation);
			if (result == null)
				result = caseClassifier(virtualMemoryImplementation);
			if (result == null)
				result = caseSubcomponentType(virtualMemoryImplementation);
			if (result == null)
				result = caseFeatureClassifier(virtualMemoryImplementation);
			if (result == null)
				result = caseNamespace(virtualMemoryImplementation);
			if (result == null)
				result = caseType(virtualMemoryImplementation);
			if (result == null)
				result = caseNamedElement(virtualMemoryImplementation);
			if (result == null)
				result = caseElement(virtualMemoryImplementation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_PROTOTYPE: {
			VirtualMemoryPrototype virtualMemoryPrototype = (VirtualMemoryPrototype) theEObject;
			T result = caseVirtualMemoryPrototype(virtualMemoryPrototype);
			if (result == null)
				result = caseComponentPrototype(virtualMemoryPrototype);
			if (result == null)
				result = caseVirtualMemory(virtualMemoryPrototype);
			if (result == null)
				result = caseVirtualMemorySubcomponentType(virtualMemoryPrototype);
			if (result == null)
				result = casePrototype(virtualMemoryPrototype);
			if (result == null)
				result = caseSubcomponentType(virtualMemoryPrototype);
			if (result == null)
				result = caseFeatureClassifier(virtualMemoryPrototype);
			if (result == null)
				result = caseStructuralFeature(virtualMemoryPrototype);
			if (result == null)
				result = caseCalledSubprogram(virtualMemoryPrototype);
			if (result == null)
				result = caseType(virtualMemoryPrototype);
			if (result == null)
				result = caseRefinableElement(virtualMemoryPrototype);
			if (result == null)
				result = caseClassifierFeature(virtualMemoryPrototype);
			if (result == null)
				result = caseNamedElement(virtualMemoryPrototype);
			if (result == null)
				result = caseElement(virtualMemoryPrototype);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_SUBCOMPONENT: {
			VirtualMemorySubcomponent virtualMemorySubcomponent = (VirtualMemorySubcomponent) theEObject;
			T result = caseVirtualMemorySubcomponent(virtualMemorySubcomponent);
			if (result == null)
				result = caseSubcomponent(virtualMemorySubcomponent);
			if (result == null)
				result = caseVirtualMemory(virtualMemorySubcomponent);
			if (result == null)
				result = caseStructuralFeature(virtualMemorySubcomponent);
			if (result == null)
				result = caseModalElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseContext(virtualMemorySubcomponent);
			if (result == null)
				result = caseFlowElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseArrayableElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseRefinableElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseClassifierFeature(virtualMemorySubcomponent);
			if (result == null)
				result = caseEndToEndFlowElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseNamedElement(virtualMemorySubcomponent);
			if (result == null)
				result = caseElement(virtualMemorySubcomponent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Aadl2Package.VIRTUAL_MEMORY_SUBCOMPONENT_TYPE: {
			VirtualMemorySubcomponentType virtualMemorySubcomponentType = (VirtualMemorySubcomponentType) theEObject;
			T result = caseVirtualMemorySubcomponentType(virtualMemorySubcomponentType);
			if (result == null)
				result = caseSubcomponentType(virtualMemorySubcomponentType);
			if (result == null)
				result = caseType(virtualMemorySubcomponentType);
			if (result == null)
				result = caseNamedElement(virtualMemorySubcomponentType);
			if (result == null)
				result = caseElement(virtualMemorySubcomponentType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseVirtualMemory(VirtualMemory object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Classifier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Classifier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemoryClassifier(VirtualMemoryClassifier object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemoryType(VirtualMemoryType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Implementation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Implementation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemoryImplementation(VirtualMemoryImplementation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Prototype</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Prototype</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemoryPrototype(VirtualMemoryPrototype object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Subcomponent</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Subcomponent</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemorySubcomponent(VirtualMemorySubcomponent object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Virtual Memory Subcomponent Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Virtual Memory Subcomponent Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVirtualMemorySubcomponentType(VirtualMemorySubcomponentType object) {
		return null;
	}
